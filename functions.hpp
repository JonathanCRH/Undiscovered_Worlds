...
//void landfill(const const planet &world, region &region, int dx, int dy, int sx, int sy, int surfaceleve, boolshapetemplate smalllake[]);
...
void disruptlakecoastline(const planet& world, region& region, int dx, int dy, int centrex, int centrey, int surfacelevel, int avedepth, bool raise, int size, bool stayintile, int special, boolshapetemplate smalllake[]);
...
void assignridgeregions(const planet& world, region& region, int dx, int dy, int sx, int sy, vector<vector<int>>& rmountainmap, vector<vector<int>>& ridgeids, vector<vector<int>>& ridgeregions, vector<vector<int>>& nearestridgepointx, vector<vector<int>>& nearestridgepointy, int smallermaxdist, int maxdist);
...
//void addmountainsprings(const const planet &world, region &region, int dx, int dy, int sx, int sy);
...
//void checkgrid(const const planet &world, region &region, int dx, int dy, int sx, int sy, vector<vector<int>> &elevs, vector<vector<int>> &severities);
...
void makesubmarineridgelines(const planet& world, region& region, int dx, int dy, int s, int sy, vector<vector<bool>>& undersearidgelines);
...
void makesubmarineriftradiations(const planet& world, region& region, int dx, int dy, int sx, int sy, vector<vector<int>>& undersearidges, peaktemplate& peaks, int extra);

...
void saveworld(planet& world, string filename)
{
    ...
    outfile << world.width() << "\n";
    outfile << world.height() << "\n";
    outfile << world.seed() << "\n";
    outfile << world.rotation() << "\n";
    outfile << world.riverfactor() << "\n";
    outfile << world.riverlandreduce() << "\n";
    outfile << world.estuarylimit() << "\n";
    outfile << world.glacialtemp () << "\n";
    outfile << world.glaciertemp() << "\n";
    outfile << world.mountainreduce() << "\n";
    outfile << world.climatenumber() << "\n";
    outfile << world.maxelevation() << "\n";
    outfile << world.sealevel() << "\n";
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.maxtemp(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.mintemp(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.climate(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.summerrain(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.winterrain(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.wintermountainrain(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.summermountainrain(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.wintermountainraindir(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.summermountainraindir(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.seaice(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.riverdir(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.riverjan(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.riverjul(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.wind(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.lakesurface(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.roughness(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.mountainridge(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.mountainheight(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.nom(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.tide(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.riftlakesurface(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.riftlakebed(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.lakestart(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.special(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.extraelev(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.deltadir(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.deltajan(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.deltajul(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.island(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.mountainisland(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.noisemap(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.oceanridges(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.oceanridgeheights(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.oceanrifts(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.oceanridgeoffset(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.oceanridgeangle(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.volcano(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.strato(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.noshade(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
            outfile << world.test(i, j) << "\n";
    }

    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < 6; j++)
            outfile << world.horse(i, j) << "\n";
    }
...
bool loadworld(planet& world, string filename)
{
    ...
    getline(infile, line);
    bval = stob(line);
    world.setrotation(bval);

    getline(infile, line);
    fval = stof(line);
    world.setriverfactor(fval);

    getline(infile, line);
    val = stoi(line);
    world.setriverlandreduce(val);

    getline(infile, line);
    val = stoi(line);
    world.setestuarylimit(val);

    getline(infile, line);
    val = stoi(line);
    world.setglacialtemp(val);

    getline(infile, line);
    val = stoi(line);
    world.setglaciertemp(val);

    getline(infile, line);
    fval = stof(line);
    world.setmountainreduce(fval);

    getline(infile, line);
    val = stoi(line);
    world.setclimatenumber(val);

    getline(infile, line);
    val = stoi(line);
    world.setmaxelevation(val);

    getline(infile, line);
    val = stoi(line);
    world.setsealevel(val);
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            val = stoi(line);
            world.setwintermountainrain(i, j, val);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            val = stoi(line);
            world.setsummermountainrain(i, j, val);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            sval = stos(line);
            world.setwintermountainraindir(i, j, sval);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            sval = stos(line);
            world.setsummermountainraindir(i, j, sval);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            val = stoi(line);
            world.setmountainridge(i, j, val);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            val = stoi(line);
            world.setmountainheight(i, j, val);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            val = stoi(line);
            world.setriftlakesurface(i, j, val);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            bval = stob(line);
            world.setmountainisland(i, j, bval);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            val = stoi(line);
            world.setoceanridgeheights(i, j, val);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            val = stoi(line);
            world.setoceanridgeoffset(i, j, val);
        }
    }
    ...
    for (int i = 0; i < ARRAYWIDTH; i++)
    {
        for (int j = 0; j < ARRAYHEIGHT; j++)
        {
            getline(infile, line);
            val = stoi(line);
            world.setoceanridgeangle(i, j, val);
        }
    }
